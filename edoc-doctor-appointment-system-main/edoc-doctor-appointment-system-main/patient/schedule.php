                            ...
                            <table width="100%" class="sub-table scrolldown" border="0" style="padding: 50px;border:none">
                                ...
                                if ($result->num_rows == 0) {
                                    echo '<tr>
                                        <td colspan="4">
                                            ...
                                            <center>
                                                ...
                                                <br>
                                                <p class="heading-main12" style="font-size:20px;color:rgb(49, 49, 49)">We couldn find anything related to your keywords!</p>
                                    ...
                                    for ($x = 0; $x < $result->num_rows; $x++) {
                                        ...
                                        echo '<tr>
                                            <td style="width: 25%;">
                                                <div class="dashboard-items search-items" style="background-color: rgb(255, 255, 255);">
                                                    <div style="width: 100%;">
                                                        <div class="h1-search">
                                                            ' . substr($title, 0, 21) . '
                                                        </div><br>
                                                        ...
                                                        <div class="h4-search">
                                                            ' . $scheduledate . '<br>Starts: ' . substr($scheduletime, 0, 5) . '
                                                        </div>
                                                        <br>
                                                        <a href="booking.php?id=' . $scheduleid . '" ><button class="login-btn btn-primary-soft btn" style="padding-top:11px;padding-bottom:11px;width:100%">Book Now</button></a>
                                                    </div>
                                                </div>
                                            </td>';
                                    }
